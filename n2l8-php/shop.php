...
<head>
    ...
    <style>
        .modal-overlay { display:none; position:fixed; inset:0; background:rgba(0,0,0,0.85); z-index:1000; align-items:center; justify-content:center; animation:fadeIn 0.2s ease; }
        .modal-overlay.open { display:flex; }
        .modal-box { background:var(--bg-card); border:1px solid var(--text-muted); box-shadow:0 0 40px rgba(51,255,153,0.15); width:90%; max-width:780px; max-height:90vh; overflow-y:auto; position:relative; display:grid; grid-template-columns:260px 1fr; }
        ...
        .modal-close { position:absolute; top:1rem; right:1rem; background:transparent; border:none; color:var(--text-muted); font-size:1.8rem; cursor:pointer; line-height:1; transition:color 0.2s; font-family:'VT323',monospace; }
        ...
        .track-item { display:flex; align-items:center; gap:0.8rem; padding:0.5rem 0.6rem; cursor:pointer; border-left:2px solid transparent; transition:all 0.15s ease; }
        ...
        .player-btn { background:transparent; border:none; color:var(--text-main); font-size:1.4rem; cursor:pointer; padding:0.2rem 0.4rem; transition:color 0.2s,text-shadow 0.2s; font-family:'VT323',monospace; line-height:1; }
        .player-btn:hover { color:var(--accent); text-shadow:0 0 8px rgba(255,194,92,0.6); }
        .progress-wrap { flex:1; height:4px; background:rgba(123,225,168,0.2); cursor:pointer; position:relative; }
        .progress-bar { height:100%; background:var(--text-main); width:0%; transition:width 0.1s linear; box-shadow:0 0 6px rgba(51,255,153,0.6); }
        ...
        @media(max-width:640px){ .modal-box{grid-template-columns:1fr;} .modal-cover-col{border-right:none;border-bottom:1px solid var(--text-muted);} }
    </style>
</head>
